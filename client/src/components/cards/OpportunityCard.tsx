  ...
  return (
    <div
      ...
      <div className='flex flex-col md:flex-row gap-4'>
        {/*company log image section*/}
        <div className='w-full md:w-40 m-0 md:m-6'>
        ...
        <div className={'w-full flex flex-col'}>
          {/*detail section*/}
          <div className='p-4 flex lg:flex-row gap-2 flex-col  rounded-md  w-full'>
            <div>
            ...
            <div className='flex flex-col md:flex-row  md:justify-between flex-1 md:items-center py-3 px-2 gap-4'>
              ...
              <div className='flex gap-4 '>
                <button className='w-28 md:w-48 md:px-6 md:py-3 text-sm bg-green-500 text-white px-2 py-2 rounded-lg '>
                  Apply
                </button>
                <button className='w-28 md:w-48 md:px-6 md:py-3 text-sm bg-slate-600 text-white px-2 py-2 rounded-lg '>
                  Decline
                </button>
              </div>
            </div>
